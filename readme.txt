=== Webfonts Wordpress Json Without Editor Plugin ===
...
Note: Make sure that the plugin folder name is "WebfontsWordpressJsonWithoutEditor" else the plugin won't function properly.